  ...
  <ol class="terms-content">
    <li>
            <dl>
                ...
                <dd>본 약관은 ONOP(이하 "회사")가 운영하는 글로벌 소싱 플랫폼(이하 "서비스")을 이용함에 있어 "회사"와 회원간의 이용 조건 및 제반 절차, 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 한다.</dd>
            </dl>
        </li>
        <li>
            <dl>
                ...
                <dd>
                    ...
                    <ol>
                        <li>
                            ① "사이트"라 함은 회사가 서비스를 "회원"에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 설정한 가상의 영업장 또는 회사가 운영하는 웹사이트, 모바일웹, 앱 등의 서비스를 제공하는 모든 매체를 통칭하며, 통합된 하나의 회원 계정(아이디 및 비밀번호)을 이용하여 서비스를 제공받을 수 있는 사이트를 말한다.
                            <ul>
            ...
            <dl>
                ...
                <dd>
                    <ol>
                        ...
                        <li>④ 구글 등 외부 서비스와의 연동을 통해 이용계약을 신청할 경우, 본 약관과 개인정보처리방침, 서비스 제공을 위해 "회사"가 "회원"의 외부 서비스 계정 정보 접근 및 활용에 "동의" 또는 "확인" 버튼을 누르면 "회사"가 웹상의 안내 및 전자메일로 "회원"에게 통지함으로써 이용계약이 성립된다.</li>
                    </ol>
                </dd>
            </dl>
        </li>
        ...
        <li>
            <dl>
                <dt><strong>제 8 조 (회원, 이력서 및 게시물 등의 정보) </strong></dt>
                <dd>
                    <ol>
                        ...
                        <li>③ "회사"는 "회원"이 이력서의 인재정보 등록 및 제공을 희망했을 경우, 기업회원의 이력서 열람 및 각종 포지션 제안에 동의한 것으로 간주하며 "회사"는 기업회원에게 이력서 열람 서비스를 제공할 수 있다. 다만, 연락처 각 항목이 비공개로 지정된 경우 해당 항목별 연락처를 노출할 수 없다.</li>
                        ; <li>③ "회사"는 "회원"이 이력서의 인재정보 등록 및 제공을 희망했을 경우, 기업회원의 이력서 열람 및 각종 포지션 제안에 동의한 것으로 간주하며 "회사"는 기업회원에게 유료로 이력서 열람 서비스를 제공할 수 있다. 다만, 연락처 각 항목이 비공개로 지정된 경우 해당 항목별 연락처를 노출할 수 없다.</li>
                        <li>④ "회사"는 안정적인 서비스를 제공하기 위해 테스트 및 모니터링 용도로 "사이트" 운영자가 이력서 및 게시물 등의 정보를 열람하도록 할 수 있다.</li>
                        <li>⑤ "회사"는 "회원"의 선택에 의하여 등록 및 제공되는 이력서 및 게시물 등의 정보를 기준으로 구직활동에 보다 유익한 서비스를 제공하기 위하여 이를 개발, 편집, 재구성한 통계 자료로 활용 할 수 있다.</li>
                    </ol>
                </dd>
            </dl>
        </li>
            ...
            <dl>
                ...
                <dd>
                    <ol>
                        ...
                        <li>② 제8조 제3항에 따라 "사이트"에서 정당한 절차를 거쳐 기업회원이 열람한 "회원"의 이력서 정보는 해당 기업의 인사자료이며 이에 대한 관리 권한은 해당 기업의 정책에 의한다.</li>
                        <li>③ "회사"는 "사이트"의 온라인 입사지원 시스템을 통해 지원한 "회원"의 이력서 열람 여부 및 기업회원이 제공한 채용정보에 입사지원한 구직자들의 각종 통계데이터를 "회원"에게 제공할 수 있다.</li>
                        <li>④ "회원"이 사이트에 게시한 게시물(사진, 각종 파일을 포함하며, 이하 "자료내용")은 "회사"가 서비스 홍보 목적을 위해 활용할 수 있다.</li>
                        <li>⑤ "자료내용"의 저작권은 해당 "자료내용"의 저작자에게 귀속된다. 다만 "회원"은 서비스를 통해 "자료내용"을 게시함으로써 "회사"에 대하여 이에 대한 이용, 복사, 복제, 처리, 각색, 변경, 공개, 전송, 게재 또는 배포할 수 있는 독점적이며 무상의 이용권한(2차적 저작물을 작성할 수 있는 권리 포함)을 부여한 것으로 간주된다.</li>
                        <li>⑥ "자료내용"은 검색결과 내지 서비스 및 관련 프로모션 등에 노출될 수 있으며, 해당 노출을 위해 필요한 범위 내에서는 일부 수정, 복제, 편집되어 게시될 수 있다. 이 경우, "회사"는 저작권법 규정을 준수하며, "회원"은 언제든지 해당 "자료내용"에 대해 삭제, 비공개 등을 요구할 수 있다.</li>
                    </ol>
                </dd>
            </dl>
        </li>
        ...
        <li>
            <dl>
                ...
                <dd>
                    <ol>
                        <li>① "회원"은 언제든지 회원탈퇴 또는 이력서 등록을 해지하기 위해 고객센터 등을 통하여 이용계약 해지 신청을 할 수 있으며, "회사"는 관련법 등이 정하는 바에 따라 이를 처리한다.</li>
                        ...
                        <li>⑤ "회사"는 성희롱, 욕설, 위협, 사실과 다른 주장, 무리한 요구, 폭언, 협박, 공포심 또는 불안감 유발, 허위사실의 유포, 기타 위계나 위력, 서비스의 고의적 악용 등의 방법으로 서비스의 운영을 방해하거나 고객 응대 근로자의 정신적 충격을 유발하는 "회원"에게 고객센터 전화 안내 서비스를 제공하지 않을 수 있다. 해당 "회원"은 헬프데스크 메일이나 문의 프로세스를 이용할 수 있으며, 해당 프로세스에 따라 전화 안내 제한에 대한 이의신청을 할 수 있다.</li>
                    </ol>
                </dd>
            </dl>
        </li>
        <li>
            <dl>
                <dt><strong>제 20 조 (손해배상) </strong></dt>
                <dd>
                    <ol>
                        <li>① "회사"가 이 약관의 규정을 위반한 행위로 "회원"에게 손해를 입히거나 기타 "회사"가 제공하는 모든 서비스와 관련하여 "회사"의 책임 있는 사유로 인해 이용자에게 손해가 발생한 경우 "회사"는 그 손해를 배상하여야 한다. </li>
                        <li>② "회사"는 책임 있는 사유로 제공한 정보가 사실과 달라 "회원"이 손해를 입었을 경우에는 "회사"는 그 손해를 배상하여야 한다. </li>
        ...
        <li>
            <dl>
                <dt><strong>제 21 조 (양도 금지) </strong></dt>
                <dd>
        ...
        <li>
            <dl>
                <dt><strong>제 22 조 (이용요금 오류의 조정) </strong></dt>
                <dd>
        ...
        <li>
            <dl>
                <dt><strong>제 25 조 (분쟁의 해결) </strong></dt>
                <dd>
                    <ol>
