...
<template>
  <div class="max-w-[1200px] mx-auto px-4 py-12">
    ...
    <div v-else-if="filteredFaqs.length === 0" class="text-center py-12 text-gray-500">등록된 FAQ가 없습니다.</div>
    ...
    <div v-else class="space-y-2">
      ...
      >
        <div class="flex items-center justify-between p-5 cursor-pointer hover:bg-gray-50" @click="toggleFaq(index)">
        ...
        <div v-show="activeIndex === index" class="p-5 border-t bg-gray-50">
