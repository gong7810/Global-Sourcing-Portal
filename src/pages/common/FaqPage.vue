...
const faqs = ref([
  ...
  },
  {
    ...
    answer: '주로 일본, 중국, 베트남 등 아시아 국가의 IT 인재들이 등록되어 있으며, 지속적으로 다양한 국가의 인재풀을 확대하고 있습니다.'
  },
  {
    question: '채용 공고는 어떻게 등록하나요?',
    answer: '기업 회원으로 가입 후, 대시보드의 "공고 등록" 메뉴를 통해 채용 공고를 등록할 수 있습니다. 상세한 정보와 우대사항을 입력하시면 됩니다.'
  },
  {
