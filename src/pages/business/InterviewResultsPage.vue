    ...
    >
      <div v-if="selectedDetailInterview" class="p-4">
          ...
          <div class="grid grid-cols-[1fr_1fr_auto] gap-x-8">
            ...
            <div class="flex flex-col items-center gap-2">
              <div class="w-[140px] h-[180px] bg-gray-100 rounded-lg overflow-hidden">
                <img
                  v-if="selectedDetailInterview.candidate.profileImage?.exists"
                  :src="selectedDetailInterview.candidate.profileImage.url"
                  alt="프로필 사진"
              ...
              <button
                v-if="selectedDetailInterview.candidate.profileImage?.exists"
                @click="downloadFile('프로필사진', selectedDetailInterview.candidate.profileImage)"
        ...
        <div class="bg-gray-50 p-6 rounded-lg mb-6">
          ...
          <div v-if="selectedDetailInterview.candidate.education?.length">
            <div class="text-[#8B8BF5] mb-4">
              최종학력: {{ selectedDetailInterview.candidate.education[0].school }} 
              ({{ selectedDetailInterview.candidate.education[0].degree }})
            </div>
            <div v-for="(edu, index) in selectedDetailInterview.candidate.education" 
              :key="index"
        ...
        <div class="bg-gray-50 p-6 rounded-lg">
          ...
          <div v-if="selectedDetailInterview.candidate.certificates?.length" class="space-y-4">
            <div v-for="(cert, index) in selectedDetailInterview.candidate.certificates" 
              :key="index" 
